...
public final class ExtensionLoader<S> {
    ...
    private Map<String, S> providers = new ConcurrentHashMap<>();

    // cached extension name and extension className
    private Map<String, String> nameClassMap = new ConcurrentHashMap<>();
    ...
    /**
     * get extension by name that configured in SPI annotation
     * @return
     */
    public S get(){
